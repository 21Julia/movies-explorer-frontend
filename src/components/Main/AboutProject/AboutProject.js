    ...
    <section className="about-project">
        ...
        <ul className="about-project__details">
          <li className="about-project__detail">
            <p className="about-project__detail-title">Дипломный проект включал 5 этапов</p>
          ...
          <li className="about-project__detail">
            <p className="about-project__detail-title">На выполнение диплома ушло 5 недель</p>
